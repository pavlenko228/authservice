...
public class RegistrationRequest {
    ...
    @Schema(description = "Username", example = "Jon Week")
    @Size(min = 8, max = 50, message = "Имя пользователя должно содержать от 5 до 50 символов")
    ...
    @Schema(description = "Phone nuber", example = "my_1secret1_password")
